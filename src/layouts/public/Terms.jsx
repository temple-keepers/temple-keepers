    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="glass-card p-8 prose dark:prose-invert max-w-none">
          ...
          <p>
            The Service, including its design, functionality, text, graphics, and code, is owned by 
            Sagacity Network Ltd and protected by copyright, trademark, and other laws. You may not 
            copy, modify, distribute, or create derivative works without written permission.
          </p>

          <h3>8.2 Trademarks</h3>
          <p>
            "Temple Keepers" and our logo are trademarks of Sagacity Network Ltd. Use without permission 
            is prohibited.
          </p>
          ...
          <p>
            ...
            between you and Sagacity Network Ltd regarding the Service.
          </p>
          ...
          <p>
            ...
            Email: legal@templekeepers.com<br />
