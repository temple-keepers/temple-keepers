          ...
          <div className="fixed top-[65px] right-0 bottom-0 w-72 bg-white dark:bg-gray-800 shadow-xl z-50 lg:hidden overflow-y-auto">
            ...
            {profile?.role === 'admin' && (
              <div className="px-3 border-t border-gray-200 dark:border-gray-700 pt-3 mt-2">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                >
            ...
            <div className="px-3 pb-4 border-t border-gray-200 dark:border-gray-700 mt-3 pt-3">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all font-medium"
              >
