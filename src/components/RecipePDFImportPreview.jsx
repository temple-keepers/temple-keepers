      ...
      <div className="relative z-10 flex flex-col items-center justify-center py-16 px-6 text-center">
        ...
        <div className="mb-6 relative">
          ...
          <div className="absolute inset-0 blur-2xl opacity-50">
            <div className="w-24 h-24 bg-amber-500/50 rounded-full" />
          </div>
...
<button
  ...
  className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer"
>
  <Upload className="w-5 h-5" />
  <span>Import PDF Recipes</span>
  
  {/* Button glow */}
  <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 blur-lg opacity-50 group-hover:opacity-75 -z-10 transition-opacity" />
</button>

<p className="text-xs text-gray-500 mt-4">
  Click to learn about upcoming PDF import feature
</p>
